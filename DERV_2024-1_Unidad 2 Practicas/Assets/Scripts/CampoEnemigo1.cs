...
public class CampoEnemigo1 : MonoBehaviour
{
    [SerializeField]
    ...
    void Update()
    {
        ...
        if(entra_campo_enemigo && entra_angulo_vision_enemigo == true && hay_obstaculos == false)
        {
            this.transform.position = Vector3.MoveTowards(
                this.transform.position,
                transform_jugador.transform.position,
                Time.deltaTime * 2f);


            Vector3 pos = transform_jugador.transform.position;
